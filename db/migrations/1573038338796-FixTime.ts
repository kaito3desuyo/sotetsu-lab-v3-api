...
export class FixTime1573038338796 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<any> {
    await queryRunner.query(
      `ALTER TABLE "times" DROP CONSTRAINT "FK_879c2fa6284e7118a501ed9eaf0"`,
    );
    await queryRunner.query(
      `ALTER TABLE "times" ADD CONSTRAINT "FK_879c2fa6284e7118a501ed9eaf0" FOREIGN KEY ("trip_id") REFERENCES "trips"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
  }
