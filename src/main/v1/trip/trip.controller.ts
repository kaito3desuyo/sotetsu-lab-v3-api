...
export class TripController {
                ...
                observer.push(
                    this.tripOperationListService.update(tripOperationList.id, {
                        start_time_id: find(
                            ...
                            (o) =>
                                o.station_id ===
                                tripOperationList.start_station_id,
                        )
                            ? find(
                                  times,
                                  (o) =>
                        ...
                        end_time_id: find(
                            ...
                            (o) =>
                                o.station_id ===
                                tripOperationList.end_station_id,
                        )
                            ? find(
                                  times,
                                  (o) =>
     ...
     */
    @Get('/classes')
    async getTripClasses(
        @Query() query: { service_id: string },
    ): Promise<{
