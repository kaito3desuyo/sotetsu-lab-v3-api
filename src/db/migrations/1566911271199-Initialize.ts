...
export class Initialize1566911271199 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        await queryRunner.query(`CREATE TABLE "stations" ("id" SERIAL NOT NULL, "station_name" character varying NOT NULL, "station_subname" character varying NOT NULL, "station_type" integer NOT NULL, "station_description" character varying NOT NULL, "station_latlng" geometry(Point,4326) NOT NULL, "station_url" character varying NOT NULL, "wheelchair_boarding" boolean NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_f047974bd453c85b08bab349367" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "route_station_lists" ("id" SERIAL NOT NULL, "station_sequence" integer NOT NULL, "station_numbering" character varying NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "route_id" integer, "station_id" integer, CONSTRAINT "PK_2613fe4e15e0929ebc06c9a96ba" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "routes" ("id" SERIAL NOT NULL, "route_number" integer NOT NULL, "route_name" character varying NOT NULL, "route_nickname" character varying NOT NULL, "route_description" character varying NOT NULL, "route_type" integer NOT NULL, "route_url" character varying NOT NULL, "route_color" character varying NOT NULL, "route_text_color" character varying NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "agency_id" integer, CONSTRAINT "PK_76100511cdfa1d013c859f01d8b" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "agencies" ("id" SERIAL NOT NULL, "agency_number" character varying NOT NULL, "parent_agency_number" character varying NOT NULL, "agency_official_name" character varying NOT NULL, "agency_name" character varying NOT NULL, "agency_type" integer NOT NULL, "agency_url" character varying NOT NULL, "agency_phone" character varying NOT NULL, "agency_fare_url" character varying NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_8ab1f1f53f56c8255b0d7e68b28" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "vehicles" ("id" SERIAL NOT NULL, "vehicle_number" character varying NOT NULL, "belongs" character varying NOT NULL, "production_date" date NOT NULL, "scrapped_date" date NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_18d8646b59304dce4af3a9e35b6" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "vehicle_formations" ("id" SERIAL NOT NULL, "formation_id" integer NOT NULL, "vehicle_id" integer NOT NULL, "car_number" integer NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_646538c1681430517abb70916b0" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "formations" ("id" SERIAL NOT NULL, "agency_id" character varying NOT NULL, "vehicle_type" character varying NOT NULL, "formation_number" character varying NOT NULL, "formation_description" character varying NOT NULL, "start_date" date NOT NULL, "end_date" date NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_e071aaba3322392364953ba5c95" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "operation_sightings" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "formation_id" integer NOT NULL, "operation_id" integer NOT NULL, "sighting_time" TIMESTAMP NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_adb9904d9ab5500d5eb529857b5" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "operations" ("id" SERIAL NOT NULL, "calender_id" integer NOT NULL, "operation_number" character varying NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_7b62d84d6f9912b975987165856" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "calenders" ("id" SERIAL NOT NULL, "calender_name" character varying NOT NULL, "sunday" boolean NOT NULL, "monday" boolean NOT NULL, "tuesday" boolean NOT NULL, "wednesday" boolean NOT NULL, "thursday" boolean NOT NULL, "friday" boolean NOT NULL, "saturday" boolean NOT NULL, "start_date" date NOT NULL, "end_date" date NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_5982bfd67e80c36271e647be082" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "routes" ADD CONSTRAINT "FK_7642ed6f5276084f2e463793c29" FOREIGN KEY ("agency_id") REFERENCES "agencies"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`ALTER TABLE "routes" DROP CONSTRAINT "FK_7642ed6f5276084f2e463793c29"`);
