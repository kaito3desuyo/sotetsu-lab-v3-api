...
import * as tripsSeed from '../seeds/operation_table_20170318.json';

export class SeedTrip201703181579411488974 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<any> {
    const data = await tripsSeedToSaveData(tripsSeed, '2017-03-18');
