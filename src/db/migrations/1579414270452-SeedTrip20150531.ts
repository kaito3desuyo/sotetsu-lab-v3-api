...
import * as tripsSeed from '../seeds/operation_table_20150531.json';

export class SeedTrip201505311579414270452 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<any> {
    const data = await tripsSeedToSaveData(tripsSeed, '2015-05-31');
