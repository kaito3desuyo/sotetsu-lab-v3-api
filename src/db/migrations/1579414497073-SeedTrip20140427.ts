...
import * as tripsSeed from '../seeds/operation_table_20140427.json';
...
export class SeedTrip201404271579414497073 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<any> {
    const data = await tripsSeedToSaveData(tripsSeed, '2014-04-27');
