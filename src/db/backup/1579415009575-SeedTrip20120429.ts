...
import * as tripsSeed from '../seeds/operation_table_20120429.json';

export class SeedTrip201204291579415009575 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<any> {
    const data = await tripsSeedToSaveData(tripsSeed, '2012-04-29');
